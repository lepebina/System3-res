...
public class CombinedStepsForStaticAnalysisPFOnePJTwo {
    ...
    public void tagertPFOneEmailForPFOnePJTwoDup(String url, String name, String surname, String email, String gender, String phone, String cell, String newPassword, String cep, String productURL) throws Throwable {
    ...
    public void tagertPJTwoWithoutEmail(String url, String company, String fantasyName, String newPassword, String cep, String productURL) {
        _evidence.startScenario(_log, _scenario.getName());
        TestStepData step = new TestStepData(_scenario.getName()
                , "I am at %URL% <PJ>")
                .add("URL", url);
